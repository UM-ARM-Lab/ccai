...
def test():
    ...
    vf_weights = [0.3, 0.5, 0.7]
    other_weights = [0.01, 0.05, 0.1, 0.2, 0.3]
         ...
         for other_weight in other_weights:
            ...
            for i in range(n_samples):
                pose_vf = pregrasp(env, config, chain, deterministic=True, 
                            initialization = initializations[i], useVFgrads=True, vf_weight = vf_weight, other_weight = other_weight,
                            vis_plan=False, iters = 500)
