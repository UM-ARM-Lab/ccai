    ...
    while iteration < max_iterations:
        ...
        for vf_weight in vf_weights:
            for other_weight in other_weights:
                ...
                print(f"vf_weight: {vf_weight}, other_weight: {other_weight}, total_cost: {total_cost}")
        ...
        results.append((best_vf_weight, best_other_weight, lowest_total_cost))
