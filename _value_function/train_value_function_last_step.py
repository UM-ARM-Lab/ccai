...
def save_train_test_splits(noisy=False, dataset_size=None, validation_proportion=0.1, seed=None):
    ...
    path = f'{fpath.resolve()}/value_functions/dataloader_last_step.pkl'
...
def load_ensemble(device='cpu', model_name = "throwerror"):
    ...
    shape = (15,1)
    checkpoints = torch.load(f'{fpath.resolve()}/value_functions/value_function_last_step_{model_name}.pkl')
...
if __name__ == "__main__":
    ...
    noisy = False
    if noisy:
        path = f'{fpath.resolve()}/value_functions/value_function_last_step_ensemble_noisy.pkl'
        model_name = "ensemble_noisy"
    else:
        path = f'{fpath.resolve()}/value_functions/value_function_last_step_ensemble.pkl'
        model_name = "ensemble"
