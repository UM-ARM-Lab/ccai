...
if __name__ == "__main__":
    ...
    for i in tqdm(range(len(initial_poses))):
        ...
        _,initial_final_pose = do_trial(env, params, fpath, initial_pose, sim_env, ros_copy_node)
        ...
        _,optimized_final_pose = do_trial(env, params, fpath, initial_pose, sim_env, ros_copy_node)
