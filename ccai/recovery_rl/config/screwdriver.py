...
'''
Probabilistic dynamics model from PETS implementation in
...
'''
Configs for MPC with CEM, built on
https://github.com/quanvuong/handful-of-trials-pytorch
'''


class ScrewdriverConfigModule:
    ENV_NAME = "Screwdriver-v0"
    TASK_HORIZON = 100
    NTRAIN_ITERS = 100
...
CONFIG_MODULE = ScrewdriverConfigModule
