...
def main(experiment_name, T_orig):
    dirpath = pathlib.Path(f'{CCAI_PATH}/data/experiments/{experiment_name}/csvgd')
    ...
    for trial_num in range(1, 51):
        try:
            ...
            offset_ind = 5 if 'valve' in experiment_name else 8
            ...
            writer = imageio.get_writer(f'{fpath}/{experiment_name}_{trial_num}_hq.mp4', fps=10,
...
if __name__ == '__main__':
    for experiment_name in ['allegro_screwdriver_new_recovery_model_old_task_model_csvto_regrasp_only_tactile_control', 'allegro_screwdriver_recovery_model_diff_only_perturb', 'allegro_screwdriver_csvto_TODR_new_recovery_model_old_task_model', 'allegro_screwdriver_csvto_diff_tactile_TODR_new_recovery_model_old_task_model']:
