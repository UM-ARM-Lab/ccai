...
sys.stdout = open('./examples/logs/recovery_MC_mode_selection_7000.log', 'w', buffering=1)
# sys.stdout = open('./examples/logs/live_recovery_hardware.log', 'w', buffering=1)
# sys.stdout = open('./examples/logs/allegro_screwdriver_csvto_live_OOD_recovery_5_10_15_likelihood_weighted_1000_no_full_dof_goal.log', 'w', buffering=1)
