...
# sys.stdout = open('./examples/logs/allegro_screwdriver_recovery_data_5_10_15_wrench_perturb_.2_std_link_regrasp_cost_new_projection_.005_cpc.log', 'w', buffering=1)
