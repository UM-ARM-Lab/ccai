...
# python -u allegro_screwdriver.py allegro_screwdriver_diff_init_new_model_3_turn_fixed_sequence_no_diff_high_budget > ./logs/allegro_screwdriver_diff_init_new_model_3_turn_fixed_sequence_no_diff_high_budget.log
# python -u allegro_screwdriver.py allegro_screwdriver > ./logs/allegro_screwdriver_diff_only.log
# python -u allegro_screwdriver.py allegro_screwdriver_diff_init_new_model_3_turn_fixed_sequence_high_budget > ./logs/allegro_screwdriver_diff_init_new_model_3_turn_fixed_sequence_high_budget.log
python -u allegro_screwdriver.py allegro_screwdriver_diff_planned_init_higher_planning_budget_mc_likelihood_less_turn_high_budget > ./logs/allegro_screwdriver_diff_planned_init_3_turn_multi_particle_new_model_less_turn_high_budget.log
...
# python make_plan_init_gifs.py allegro_screwdriver_diff_init_new_model_3_turn_fixed_sequence_no_diff_high_budget
# python make_plan_init_gifs.py allegro_screwdriver
# python make_plan_init_gifs.py allegro_screwdriver_diff_init_new_model_3_turn_fixed_sequence_high_budget
python make_plan_init_gifs.py allegro_screwdriver_diff_planned_init_higher_planning_budget_mc_likelihood_less_turn_high_budget
python make_plan_init_gifs.py allegro_screwdriver_diff_planned_init_higher_planning_budget_mc_likelihood_less_turn_replan_high_budget
