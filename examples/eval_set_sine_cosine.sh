# python -u allegro_screwdriver.py allegro_screwdriver_csvto_only > allegro_screwdriver_csvto_only_eps_.01_2.5_damping.log
# python -u allegro_screwdriver.py allegro_screwdriver_diff_sine_cosine_only > allegro_screwdriver_diff_sine_cosine_only_eps_.01_2.5_damping.log
...
python -u allegro_screwdriver.py allegro_screwdriver_csvto_diff_sine_cosine_planned_replanned_contact_single_particle > allegro_screwdriver_csvto_diff_sine_cosine_planned_replanned_contact_single_particle_eps_.01_2.5_damping.log
